...
def resolve_amplify_tables() -> dict:
    ...
    try:
        ...
        # In Amplify Gen 2, table names are saved as parameters.
        # Let's fetch parameters by path
        ...
        for page in pages:
            for param in page.get("Parameters", []):
                ...
                for model in model_keys:
                    # In Amplify Gen 2 SSM parameters map like: /amplify/prism/dev/data/SourceItem/tableName
    ...
    for model in model_keys:
        ...
        if table_key not in resolved_tables:
            # Fallback format: e.g., SOURCE_DEFINITION_TABLE or SourceDefinitionTable
